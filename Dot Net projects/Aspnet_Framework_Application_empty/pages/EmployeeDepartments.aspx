<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeDepartments.aspx.cs" Inherits="Aspnet_Framework_Application.pages.EmployeeDepartments" %>
...
<head runat="server">
    ...
    <%--<link href="../Css/EmployeeDepartments.css" rel="stylesheet" />--%>
...
<body>
    ...
    <form class="MainForm" id="frmEmployeeDepartments" runat="server">
        <asp:hiddenfield ID="hdfemployeeidmainemp" runat="server" value="Id"></asp:hiddenfield>
      <div class="CompleteDetails">
            <h2>Departments</h2>
            <div class="content">
                <div class="cell-data">
                    <label for="lbldepartment" id="lbldepartment">Departments</label>
                    <asp:TextBox runat="server" name="txtdepartment" id="txtdepartment" placeholder="Enter Your DepartmentName"/>
                </div>
            </div>
        </div>
