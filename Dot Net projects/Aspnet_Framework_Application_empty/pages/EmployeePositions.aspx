<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeePositions.aspx.cs" Inherits="Aspnet_Framework_Application.pages.EmployeePositions" %>
...
<head runat="server">
    ...
    <%--<link href="../Css/EmployeePositions.css" rel="stylesheet" />--%>
...
<body>
    ...
    <form class="MainForm" id="frmEmployeePositions" runat="server">
        <asp:hiddenfield ID="hdfemployeeidmainemp" runat="server" value="Id"></asp:hiddenfield>
       <div class="CompleteDetails">
            <h2>Positions</h2>
            <div class="content">
                <div class="cell-data">
                    <label for="lblpositions" id="lblpositions">Positions</label>
                    <asp:TextBox runat="server" name="txtpositions" id="txtpositions" placeholder="Enter your position"/>
                </div>
            </div>
        </div>
